...
corpusObj = _Corpus()
proportionThreshold = 0.7

cv = 10
for i in range(cv):
	corpusObj = _Corpus()
	proportionThreshold = 0
	inputFile = "./70_training/"+str(i)+"/cbagf.AT.txt"
	outputInferFile = "./70_training/"+str(i)+"/cbagf_infer.AT_"+str(i)+".txt"
	outputPerplexityFile = "./70_training/"+str(i)+"/cbagf_perplexity.AT_"+str(i)+".txt"
